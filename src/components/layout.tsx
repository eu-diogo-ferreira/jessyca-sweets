        ...
        <Wrapper>
          <SideBarInner bg={color} as="aside" p={[6, 6, 8]}>
            ...
            >
              <Box width={['3rem', '4rem', '5rem', '6rem']}>
                <Link to="/" aria-label="Mimos da Jessica, voltar para a Home">
                  <Logo />
                </Link>
              </Box>
              <Nav
          ...
          <Footer color={color}>
            <Box p={[6, 6, 8]} fontSize={0}>
              Criado por <a href="https://diogo-developer.netlify.com">Diogo Ferreira</a>.<br />
              <a href="https://diogo-developer.netlify.com">Henrique Design</a>.
            </Box>
          </Footer>
        </Wrapper>
      </>
